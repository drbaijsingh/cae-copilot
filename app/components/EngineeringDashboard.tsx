  ...
  return (
    <div className="space-y-4 animate-fadeIn">
      ...
      {model.parts.length > 0 && (
        <div className="glass rounded-xl p-4 border border-white/5">
          <h4 className="text-sm text-gray-400 uppercase tracking-wider mb-3">Parts</h4>
          <div className="flex flex-wrap gap-2">
      ...
      {model.steps.length > 0 && (
        <div className="glass rounded-xl p-4 border border-white/5">
          <h4 className="text-sm text-gray-400 uppercase tracking-wider mb-3">Analysis Steps</h4>
          <div className="flex flex-wrap gap-2">
      ...
      <div className="glass rounded-xl p-4 border border-white/5">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
          <div>
            ...
            <span className="ml-2 text-gray-300">{model.fileName}</span>
          </div>
          <div>
            <span className="text-gray-400">Solver:</span>
            <span className="ml-2 text-gray-300">{model.solver}</span>
          </div>
          <div>
            <span className="text-gray-400">Node Sets:</span>
            <span className="ml-2 text-gray-300">{model.nodeSets.length}</span>
          </div>
          <div>
            <span className="text-gray-400">Element Sets:</span>
            <span className="ml-2 text-gray-300">{model.elementSets.length}</span>
          </div>
        </div>
      </div>
    </div>
